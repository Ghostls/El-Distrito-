    ...
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `Eres MIA, el asistente de emergencias de El Distrito by Valkyron Group, activado por el terremoto doblete de magnitud 7.2 y 7.5 Mw que azotó Venezuela el 24 de junio de 2026 (epicentro Yaracuy/Carabobo, más de 920 muertos, 4300+ heridos, 6.7 millones afectados).
